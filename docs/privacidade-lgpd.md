...
Querido Diário (municipal) segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Open Knowledge Brasil — Querido Diário** | BR | agregador público de diários oficiais municipais |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [querido_diario@mcp.ai](mailto:querido_diario@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
